...
const MenuRepo = {
    ...
    async getArchivados() {
        return getMenusArchivadosSeguro();
    },
    ...
    async saveArchivados(arr, opts = { refresh: false }) {
        ...
        saveMenusArchivadosAndRefresh(limpio, opts);
        return limpio;
    },
...
const CarritoRepo = {
    ...
    async saveAll(items, opts = { refresh: false }) {
        ...
        saveCarritoAndRefresh(limpio, opts);
        return limpio;
    },
...
const InventarioRepo = {
    ...
    async saveAll(items, opts = { refresh: true }) {
        ...
        saveProductosAndRefresh(limpio, opts);
        return limpio;
    },
...
const DespensaRepo = {
    ...
    async saveAll(items, opts = { refresh: false }) {
        ...
        saveDespensaAndRefresh(limpio, opts);
        return limpio;
    },
...
const RecetasRepo = {
    async getAll() {
        ...
        Store.saveRecetas(normalizadas);
